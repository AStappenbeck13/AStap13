...
public class Library
{
    ...
    public Library()
    {
        ...
        try
        {
            Scanner sc = new Scanner(new File("/workspace/AStap13/ChildrensLibrary/childrensbooksearly1900s.txt"));
        ...
        } catch (Exception e) { System.out.println("Error reading or parsing /workspace/AStap13/ChildrensLibrary/childrensbooksearly1900s.txt" + e); }
    }
